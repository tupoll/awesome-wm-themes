   ...
   _mem.usep  = math.floor(_mem.inuse / _mem.total * 100)
        ...
        if _mem.usep == nil then
            ...
            elseif _mem.usep < 20 then
                mem_icon:set_image(ICON_DIR.."mem1.png")
            elseif _mem.usep < 30 then
                mem_icon:set_image(ICON_DIR.."mem2.png")
            elseif _mem.usep < 40 then
                mem_icon:set_image(ICON_DIR.."mem3.png")
            elseif _mem.usep < 50 then
                mem_icon:set_image(ICON_DIR.."mem4.png")
            elseif _mem.usep < 70 then
                mem_icon:set_image(ICON_DIR.."mem5.png")
            elseif _mem.usep < 100 then
                mem_icon:set_image(ICON_DIR.."mem6.png")
            else            
