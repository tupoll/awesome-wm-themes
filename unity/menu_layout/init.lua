...
local widget    = require("unity.layout")
...
module.qapp["MOC"]       = { command="xterm -e mocp",  key="p", icon="thunderbird.svg",      tag=6 }
...
function module.main_qapp()
    if not module.menu_qapp then
        module.menu_qapp = radical.context({
            ...
            y = screen[1].geometry.height - beautiful.wibox.width - ((#awful.util.table.keys(module.qapp))*beautiful.menu_height) - 538
        })
