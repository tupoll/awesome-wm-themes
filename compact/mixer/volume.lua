...
local path_to_icons = ".config/awesome/themes/freebsd/level/mixer/"     
...
local function worker(args)
    ...
    local volume_audio_controller = args.volume_audio_controller or 'mixer'
    ...
    volume_widget = wibox.widget {
        {
            id = "icon",
            image = path_to_icons .. "audio-volume-muted-panel.svg",
            resize = false,
