...
local path_to_icons = ".config/awesome/themes/gentoo/level/mixer/"
...
--})
    ...
    local GET_VOLUME_CMD = 'amixer  sget Speaker' --Master
    local INC_VOLUME_CMD = 'amixer  sset Speaker 5%+'
    local DEC_VOLUME_CMD = 'amixer  sset Speaker 5%-'
    local TOG_VOLUME_CMD = 'amixer  sset Speaker toggle'


    volume_widget = wibox.widget {
        {
            id = "icon",
            image = path_to_icons .. "audio-volume-muted-panel.png",
            resize = false,
