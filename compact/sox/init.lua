...
local play      = require("compact.sox.play")
...
module.aapp["ape"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/ape.sh",     key="a", icon="ape.png", }
module.aapp["flac"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/flac.sh",   key="f", icon="flac.png", }
module.aapp["mp3"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/mp3.sh",     key="m", icon="mp3.png", }
module.aapp["next"]   = { command="killall play",                                          key="k", icon="next.png", }
module.aapp["stop"]   = { command="zsh -c ~/.config/awesome/compact/sox/dr/stop.sh",    key="s", icon="stop.png", }
module.aapp["media_ape"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/media_ape.sh",     key="2", icon="ape.png", }
module.aapp["media_flac"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/media_flac.sh",   key="1", icon="flac.png", }
module.aapp["media_mp3"]    = { command="zsh -c ~/.config/awesome/compact/sox/dr/media_mp3.sh",     key="3", icon="mp3.png", }
...
local function new()
    ...
    local widget_txt,text = common.textbox({text="sox", width=50, b1=module.main_aapp, b3=module.main_papp})
    local widget_separator,text = common.textbox({text="", width=5})  
    layout:add(widget_txt)
    layout:add(play())
    layout:add(widget_separator)
    layout:add(playbar())
    return layout
end
