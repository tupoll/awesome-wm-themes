...
theme.path                            = awful.util.getdir("config").."/themes/gentoo/level"
theme.menu_submenu_icon               = theme.path.."/submenu.png"
theme.dragonfly_icon                  = theme.path.."/logos/funtoo_logo1.png"
theme.awesome_icon                    = theme.path.."/logos/awesome-icon.png"
theme.widget_bg                                 = theme.path .. "/icons/widget_bg.png"

theme.taglist_bg_focus                          = pattern(theme.path.."/tags/bg_focus.png")
...
theme.wallpaper                       = theme.path.."/Funtoo_Sepia.png"
...
theme.widget["fg"]                    = "#040202"
theme.widget["bg"]                    = "00000000"   --pattern(theme.path.."/background/wibox.png")
theme.widget["align"]                 = "center"
theme.widget["valign"]                = "center"

-- Radical menus
theme.menu_border_width               = 1
theme.menu_border_color               = "#4B301E"
...
naughty.config.defaults.fg            = "#070A07"
naughty.config.defaults.bg            = pattern(theme.path.."/background/notify.png")
