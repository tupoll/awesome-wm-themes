...
-- Volume controls
 ...
 --Avplay
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function() compact.prompt.run()                         end,
              {description = "run prompt", group = "launcher"}),

    awful.key({ modkey            }, "x",            function() compact.prompt.run()                         end,
              {description = "lua execute prompt", group = "awesome"}),
    awful.key({ modkey            }, "l",            function() compact.prompt.lua()                         end),
    awful.key({ modkey            }, "z",            function() compact.prompt.cmd()                         end),
    -- Menubar
    awful.key({ modkey }, "p", function() compact.places.main()                        end,
              {description = "show the places", group = "launcher"})
)
