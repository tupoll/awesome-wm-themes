...
theme.path                            = awful.util.getdir("config").."/themes/dragonfly/level"
theme.menu_submenu_icon               = theme.path.."/submenu.png"
theme.dragonfly_icon                  = theme.path.."/logos/dragonfly-3.png"
...
theme.wallpaper                       = theme.path.."/wooden_black_white_illusion_board_9673_1280x800.jpg"
...
naughty.config.defaults.bg            = pattern(theme.path.."/background/notifi.png")
